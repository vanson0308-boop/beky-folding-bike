...
const PRODUCTS = {
  youth: {
    ...
    colors: [
      ['#4b5d3a', { 'zh-TW': '橄欖綠', en: 'Olive', 'zh-CN': '橄榄绿' }],
      ['#e9dcc3', { 'zh-TW': '奶茶', en: 'Milk Tea', 'zh-CN': '奶茶' }],
      ['#d8e63a', { 'zh-TW': '青柚', en: 'Pomelo', 'zh-CN': '青柚' }],
      ['#2b2b2b', { 'zh-TW': '石墨黑', en: 'Graphite', 'zh-CN': '石墨黑' }],
      ['#ea5b2b', { 'zh-TW': '火焰橙', en: 'Flame Orange', 'zh-CN': '火焰橙' }],
      ['#8a8a86', { 'zh-TW': '鈦灰', en: 'Titanium Grey', 'zh-CN': '钛灰' }],
      ['#f2b8bd', { 'zh-TW': '海鹽粉', en: 'Sea Salt Pink', 'zh-CN': '海盐粉' }],
      ['#63b34a', { 'zh-TW': '蘋果綠', en: 'Apple Green', 'zh-CN': '苹果绿' }],
      ['#f39a1e', { 'zh-TW': '南瓜橙', en: 'Pumpkin', 'zh-CN': '南瓜橙' }],
    ],
  },
  skyline: {
    ...
    colors: [
      ['#3c4a35', { 'zh-TW': '軍綠', en: 'Army Green', 'zh-CN': '军绿' }],
      ['#e6a63a', { 'zh-TW': '芥末黃', en: 'Mustard', 'zh-CN': '芥末黄' }],
    ],
  },
  nano: {
    ...
    colors: [
      ['#ea5b2b', { 'zh-TW': '火焰橙', en: 'Flame Orange', 'zh-CN': '火焰橙' }],
      ['#e9dcc3', { 'zh-TW': '奶茶', en: 'Milk Tea', 'zh-CN': '奶茶' }],
      ['#2f3f4f', { 'zh-TW': '藏青', en: 'Navy', 'zh-CN': '藏青' }],
      ['#8fa38a', { 'zh-TW': '青瓷綠', en: 'Celadon', 'zh-CN': '青瓷绿' }],
      ['#9a9a96', { 'zh-TW': '全鈦', en: 'Titanium', 'zh-CN': '全钛' }],
      ['#e53f7a', { 'zh-TW': '四拼色', en: 'Multicolour', 'zh-CN': '四拼色' }],
    ],
  },
  city: {
    ...
    colors: [
      ['#2fa9c9', { 'zh-TW': '邁阿密藍', en: 'Miami Blue', 'zh-CN': '迈阿密蓝' }],
      ['#2b2b2b', { 'zh-TW': '黑金', en: 'Black Gold', 'zh-CN': '黑金' }],
      ['#3c4a35', { 'zh-TW': '墨綠', en: 'Deep Green', 'zh-CN': '墨绿' }],
      ['#e9dcc3', { 'zh-TW': '奶茶', en: 'Milk Tea', 'zh-CN': '奶茶' }],
      ['#1f6a4a', { 'zh-TW': '郵政綠', en: 'Postal Green', 'zh-CN': '邮政绿' }],
      ['#2f3f4f', { 'zh-TW': '藏青', en: 'Navy', 'zh-CN': '藏青' }],
      ['#3a2a3f', { 'zh-TW': '暗夜紫', en: 'Midnight Purple', 'zh-CN': '暗夜紫' }],
      ['#8bb35a', { 'zh-TW': '邁阿密綠', en: 'Miami Green', 'zh-CN': '迈阿密绿' }],
      ['#ea5b2b', { 'zh-TW': '火焰橙', en: 'Flame Orange', 'zh-CN': '火焰橙' }],
    ],
  },
  travel: {
    ...
    colors: [
      ['#e53f7a', { 'zh-TW': '四拼色', en: 'Multicolour', 'zh-CN': '四拼色' }],
      ['#8a8f6a', { 'zh-TW': '艾草綠 · 黑配', en: 'Sage / Black', 'zh-CN': '艾草绿 · 黑配' }],
      ['#8a8f6a', { 'zh-TW': '艾草綠 · 銀配', en: 'Sage / Silver', 'zh-CN': '艾草绿 · 银配' }],
    ],
  },
  boundless: {
    ...
    colors: [
      ['#e9dcc3', { 'zh-TW': '奶茶', en: 'Milk Tea', 'zh-CN': '奶茶' }],
      ['#2f3f4f', { 'zh-TW': '藏青', en: 'Navy', 'zh-CN': '藏青' }],
      ['#f0c419', { 'zh-TW': '機械師', en: 'Mechanic', 'zh-CN': '机械师' }],
      ['#4fd12a', { 'zh-TW': '電光綠', en: 'Electric Green', 'zh-CN': '电光绿' }],
      ['#2b2b2b', { 'zh-TW': '石墨黑', en: 'Graphite', 'zh-CN': '石墨黑' }],
      ['#1a1a1a', { 'zh-TW': '黑金', en: 'Black Gold', 'zh-CN': '黑金' }],
      ['#5a2ec7', { 'zh-TW': '電光紫', en: 'Electric Purple', 'zh-CN': '电光紫' }],
    ],
  },
};

const SPEC_LABELS = {
  wheel:   { 'zh-TW': '輪徑', en: 'Wheel size', 'zh-CN': '轮径' },
  gears:   { 'zh-TW': '變速', en: 'Gears', 'zh-CN': '变速' },
  frame:   { 'zh-TW': '車架材質', en: 'Frame', 'zh-CN': '车架材质' },
  fold:    { 'zh-TW': '折疊尺寸', en: 'Folded size', 'zh-CN': '折叠尺寸' },
  weight:  { 'zh-TW': '重量', en: 'Weight', 'zh-CN': '重量' },
  load:    { 'zh-TW': '載重', en: 'Max load', 'zh-CN': '载重' },
  headset: { 'zh-TW': '碗組', en: 'Headset', 'zh-CN': '碗组' },
};
