...
const PRODUCTS = {
  youth: {
    ...
    colors: [
      ['linear-gradient(135deg, #e9dcc3 0 62%, #c7c9cb 62%)', { 'zh-TW': '奶茶【銀配】', en: 'Milk Tea / Silver', 'zh-CN': '奶茶【银配】', ja: 'ミルクティー／シルバー' }],
      ['linear-gradient(135deg, #4b5d3a 0 62%, #c7c9cb 62%)', { 'zh-TW': '橄欖綠【銀配】', en: 'Olive Green / Silver', 'zh-CN': '橄榄绿【银配】', ja: 'オリーブグリーン／シルバー' }],
      ['linear-gradient(135deg, #d9a33a 0 62%, #c7c9cb 62%)', { 'zh-TW': '南瓜黃【銀配】', en: 'Pumpkin Yellow / Silver', 'zh-CN': '南瓜黄【银配】', ja: 'パンプキンイエロー／シルバー' }],
      ['linear-gradient(135deg, #63b34a 0 62%, #c7c9cb 62%)', { 'zh-TW': '蘋果綠【銀配】', en: 'Apple Green / Silver', 'zh-CN': '苹果绿【银配】', ja: 'アップルグリーン／シルバー' }],
      ['linear-gradient(135deg, #e9dcc3 0 62%, #202124 62%)', { 'zh-TW': '奶茶【黑配】', en: 'Milk Tea / Black', 'zh-CN': '奶茶【黑配】', ja: 'ミルクティー／ブラック' }],
      ['linear-gradient(135deg, #4b5d3a 0 62%, #202124 62%)', { 'zh-TW': '橄欖綠【黑配】', en: 'Olive Green / Black', 'zh-CN': '橄榄绿【黑配】', ja: 'オリーブグリーン／ブラック' }],
      ['linear-gradient(135deg, #8a8a86 0 62%, #202124 62%)', { 'zh-TW': '鈦灰【黑配】', en: 'Titanium Grey / Black', 'zh-CN': '钛灰【黑配】', ja: 'チタニウムグレー／ブラック' }],
      ['linear-gradient(135deg, #2b2b2b 0 62%, #202124 62%)', { 'zh-TW': '石墨黑【黑配】', en: 'Graphite Black / Black', 'zh-CN': '石墨黑【黑配】', ja: 'グラファイトブラック／ブラック' }],
    ],
  },
  skyline: {
    ...
    colors: [
      ['#c89b3c', { 'zh-TW': '沙漠金', en: 'Desert Gold', 'zh-CN': '沙漠金', ja: 'デザートゴールド' }],
      ['#4b5d3a', { 'zh-TW': '橄欖綠', en: 'Olive Green', 'zh-CN': '橄榄绿', ja: 'オリーブグリーン' }],
      ['#aeb3b7', { 'zh-TW': '馬赫銀', en: 'Mach Silver', 'zh-CN': '马赫银', ja: 'マッハシルバー' }],
    ],
  },
  nano: {
    ...
    colors: [
      ['linear-gradient(135deg, #ea5b2b 0 62%, #c7c9cb 62%)', { 'zh-TW': '火焰橙【銀配】', en: 'Flame Orange / Silver', 'zh-CN': '火焰橙【银配】', ja: 'フレイムオレンジ／シルバー' }],
      ['linear-gradient(135deg, #73a96b 0 62%, #c7c9cb 62%)', { 'zh-TW': '青蔥綠【銀配】', en: 'Verdant Green / Silver', 'zh-CN': '青葱绿【银配】', ja: '新緑グリーン／シルバー' }],
      ['conic-gradient(#ea5b2b 0 25%, #e9dcc3 25% 50%, #73a96b 50% 75%, #2f3f4f 75% 100%)', { 'zh-TW': '四拼色', en: 'Four-tone', 'zh-CN': '四拼色', ja: '4トーンカラー' }],
    ],
  },
  city: {
