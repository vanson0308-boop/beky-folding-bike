...
const PRODUCTS = {
  youth: {
    ...
    colors: [
      [['#e9dcc3', '#c7c9cb'], { 'zh-TW': '奶茶【銀配】', en: 'Milk Tea / Silver', 'zh-CN': '奶茶【银配】', ja: 'ミルクティー／シルバー' }],
      [['#4b5d3a', '#c7c9cb'], { 'zh-TW': '橄欖綠【銀配】', en: 'Olive Green / Silver', 'zh-CN': '橄榄绿【银配】', ja: 'オリーブグリーン／シルバー' }],
      [['#d9a33a', '#c7c9cb'], { 'zh-TW': '南瓜黃【銀配】', en: 'Pumpkin Yellow / Silver', 'zh-CN': '南瓜黄【银配】', ja: 'パンプキンイエロー／シルバー' }],
      [['#63b34a', '#c7c9cb'], { 'zh-TW': '蘋果綠【銀配】', en: 'Apple Green / Silver', 'zh-CN': '苹果绿【银配】', ja: 'アップルグリーン／シルバー' }],
      [['#e9dcc3', '#202124'], { 'zh-TW': '奶茶【黑配】', en: 'Milk Tea / Black', 'zh-CN': '奶茶【黑配】', ja: 'ミルクティー／ブラック' }],
      [['#4b5d3a', '#202124'], { 'zh-TW': '橄欖綠【黑配】', en: 'Olive Green / Black', 'zh-CN': '橄榄绿【黑配】', ja: 'オリーブグリーン／ブラック' }],
      [['#8a8a86', '#202124'], { 'zh-TW': '鈦灰【黑配】', en: 'Titanium Grey / Black', 'zh-CN': '钛灰【黑配】', ja: 'チタニウムグレー／ブラック' }],
      [['#2b2b2b', '#202124'], { 'zh-TW': '石墨黑【黑配】', en: 'Graphite Black / Black', 'zh-CN': '石墨黑【黑配】', ja: 'グラファイトブラック／ブラック' }],
    ],
  },
  skyline: {
  ...
  nano: {
    ...
    colors: [
      [['#ea5b2b', '#c7c9cb'], { 'zh-TW': '火焰橙【銀配】', en: 'Flame Orange / Silver', 'zh-CN': '火焰橙【银配】', ja: 'フレイムオレンジ／シルバー' }],
      [['#73a96b', '#c7c9cb'], { 'zh-TW': '青蔥綠【銀配】', en: 'Verdant Green / Silver', 'zh-CN': '青葱绿【银配】', ja: '新緑グリーン／シルバー' }],
      [['#ea5b2b', '#e9dcc3', '#73a96b', '#2f3f4f'], { 'zh-TW': '四拼色', en: 'Four-tone', 'zh-CN': '四拼色', ja: '4トーンカラー' }],
    ],
  },
  city: {
